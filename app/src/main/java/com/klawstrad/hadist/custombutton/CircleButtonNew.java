package com.klawstrad.hadist.custombutton;
...
public class CircleButtonNew extends ImageView
{
	...
	//0 left ,1 left
	private int    arrowAlignmentValue;


	public CircleButtonNew(Context context)
	{
		super(context);
		init(context, null, 0);
	}

	public CircleButtonNew(Context context, AttributeSet attrs)
	{
		super(context, attrs);
		init(context, attrs, 0);
	}

	public CircleButtonNew(Context context, AttributeSet attrs, int defStyle)
	{
	...
	protected void onDraw(Canvas canvas) {
		...
		float strokeWidth=getContext().getResources().getDimension(R.dimen.arrowStrokeWidth);
